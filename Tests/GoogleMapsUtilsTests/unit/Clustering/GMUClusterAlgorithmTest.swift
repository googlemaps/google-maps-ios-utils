...
///
class GMUClusterAlgorithmTest: XCTestCase {
    ...
    ///
    func itemsAroundLocation(_ location: CLLocationCoordinate2D, count: Int, zoom: Double, radius: Double) -> [GMUClusterItem] {
        ...
        while remainingCount > 0 {
            ...
            items.append(GMUTestClusterItem(position: nearLocation))
            remainingCount -= 1
        }
    ...
    ///
    func totalItemCountsForClusters(_ clusters: [GMUCluster]) -> Int {
        var sum: Int = 0
    ...
    ///
    func assertCluster(_ cluster1: GMUCluster, doesNotOverlapWith cluster2: GMUCluster) {
    ...
    /// 
    func assertValidClusters(_ clusters: [GMUCluster]) {
    ...
    ///
    func randomizedClusterItems() -> [GMUClusterItem] {
        let zoom = 10.0
        let radius = 50.0
        let count = 10
