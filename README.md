...
1. In your `Podfile`:
  ...
  target 'TARGET_NAME' do
    ...
    pod 'Google-Maps-iOS-Utils', '7.1.1' # x-release-please-version
  end
  ```
...
<details>
<summary>Only supported if using Maps SDK v7.1.1 or earlier</summary>

In your `Cartfile`:

```
github "googlemaps/google-maps-ios-utils" ~> 7.1.1
```
