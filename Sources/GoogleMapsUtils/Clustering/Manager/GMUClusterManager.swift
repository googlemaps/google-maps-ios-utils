...
public final class GMUClusterManager: NSObject, GMSMapViewDelegate {
    ...
    private(set) var algorithm: GMUClusterAlgorithm
    ...
    private(set) weak var delegate: GMUClusterManagerDelegate?
    ...
    private var renderer: GMUClusterRenderer
    ...
    public func cluster() {
        ...
        let clusters: [GMUCluster] = algorithm.clusters(atZoom: integralZoom)
