...
/// TO-DO: Rename the class to `GMUDefaultClusterIconGenerator` once the linking is done and remove the objective c class.
...
///
class GMUDefaultClusterIconGenerator1: GMUClusterIconGenerator1 {
