...
final class GMUWrappingDictionaryKey: NSObject, NSCopying {
    ...
    override func isEqual(_ object: Any?) -> Bool {
        ...
        guard let other = object as? GMUWrappingDictionaryKey else {
            return false
        }
    ...
    func copy(with zone: NSZone? = nil) -> Any {
        ...
        let newKey = GMUWrappingDictionaryKey(object: currentObject)
        return newKey
    }
}
