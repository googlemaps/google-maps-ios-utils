...
/// \param givenClusterIterations The number of iterations k-means clustering should go to.
///
- (nonnull instancetype)initGivenClusterIterations:(NSInteger)givenClusterIterations OBJC_DESIGNATED_INITIALIZER;
/// Adds a list of GMUWeightedLatLng objects to the input data set
/// \param latlngs The list of GMUWeightedLatLng objects to add.
///
- (void)addWeightedLatLngsWithLatlngs:(NSArray<GMUWeightedLatLng *> * _Nonnull)latlngs;
/// Adds a single GMUWeightedLatLng object to the input data set
/// \param latlngs The list of GMUWeightedLatLng objects to add.
///
- (void)addWeightedLatLngWithLatlng:(GMUWeightedLatLng * _Nonnull)latlng;
...
/// \param n The n-value, determining the range of influence the intensities found in the given data set has (see
/// HeatmapInterpolationInfluence comment for more details).
///
/// \param granularity How coarse the search range is WRT to lat/long and must be larger than 0 but smaller than 1 (as
...
///
- (NSArray<GMUWeightedLatLng *> * _Nullable)generateHeatMapsWithInfluence:(double)influence granularity:(double)granularity error:(NSError * _Nullable * _Nullable)error SWIFT_WARN_UNUSED_RESULT;
